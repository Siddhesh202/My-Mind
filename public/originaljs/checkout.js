...
function getTherapist(therapistId) {
  $.ajax({
    ...
    success: function (therapist) {
      ...
      $("#cartCost").html(
        `${parseFloat(therapistInformation.sessionCost * multiplier).toFixed(
          2
        )}`
      );
      $("#subTotal").html(
      ...
      $("#taxTotal").html(
        `₹ ${parseFloat(
          therapistInformation.sessionCost * multiplier * 0.12
        ).toFixed(2)}`
      );
      $("#total").html(
        `₹ ${parseFloat(
          therapistInformation.sessionCost * multiplier * 1.12
        ).toFixed(2)}`
      );
    },
  });
...
function printInvoice() {
  ...
  printWindow.document.write(
    '<link rel="stylesheet" type="text/css" href="../css/style.css" /><link rel="stylesheet" type="text/css" href="../css/checkout.css" /><link rel="stylesheet" type="text/css" href="../css/responsive.css" />'
  );
  printWindow.document.write(
    '</head><body> <div id="wrapper"><div id="orderSummary" style="display: block;">'
  );
  printWindow.document.write(
    '<div id="orderNumSec"><h2>Order: <span id="orderNumber">MM0509123456</span></h2></div><div id="orderTable">'
  );
