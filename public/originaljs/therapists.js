  ...
  await $.ajax({
    ...
    success: function (data) {
      ...
      data.forEach(function (Therapist) {
        ...
        x += `<p>${Therapist.yearsExperience} years of experience in the profession, and offers Rs ${Therapist.sessionCost} per session</p>`;
        ...
        if (data == "cartExists") {
          ...
          setTimeout(() => {
            ...
            $.get("/activeSession", function (data) {
              ...
              $("#expireDate").text(
                `${new Date(data.purchased).toLocaleString("en-CA", {
                  month: "short",
                  day: "numeric",
                  year: "numeric",
                })}`
